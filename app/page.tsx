...
const API_KEY = '5kCdfNpPLhXcBmx5tr'
const PRIVATE_KEY = 'ddE307lw8zbsPaaLSpVApuJifnRs3LGBjjo4'
...
export default function Home() {
  ...
  //     sendJsonMessage({"req_id": "100001", "op": "ping"});
  //     sendJsonMessage({op: "subscribe", args: ['position']});
